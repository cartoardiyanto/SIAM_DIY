    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['sub'])){
            ...
            if(isset($_REQUEST['submit'])){
                ...
                if($_REQUEST['username'] == "" || $_REQUEST['password'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['nik'] == ""){
                    ...
                    if(!preg_match("/^[a-zA-Z0-9_]*$/", $username)){
                        ...
                        if(!preg_match("/^[a-zA-Z., ]*$/", $nama)){
                            ...
                            if(!preg_match("/^[0-9 -]*$/", $nik)){
                                $_SESSION['epnip'] = 'Form NIK hanya boleh mengandung karakter angka, spasi dan minus(-)';
                                header("Location: ./admin.php?page=pro&sub=pass");
                                die();
                            } else {
                                ...
                                if(strlen($username) < 5){
                                    ...
                                    if(strlen($password) < 5){
                                        ...
                                        if(mysqli_num_rows($query) > 0){
                                            $do = mysqli_query($config, "UPDATE tbl_user SET username='$username', password=MD5('$password'), nama='$nama', nik='$nik' WHERE id_user='$id_user'");
                    ...
                    <form class="col s12" method="post" action="?page=pro&sub=pass">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s6">
                                ...
                                <input id="nik" type="text" class="validate" name="nik" value="<?php echo $_SESSION['nip']; ?>" required autocomplete="off">
                                    <?php
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="post" action="save.php">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">looks_one</i>
                            <input id="nik" type="text" value="<?php echo $_SESSION['nip']; ?>" readonly disable>
                            <label for="nik">NIK</label>
                        </div>
                    </div>
                    <!-- Row in form END -->
