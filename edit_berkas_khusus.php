<?php
 ...
 if($_SESSION['admin'] ==2){
                                                ...
                                                if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $lokasi_simpan)){
                                                    ...
                                                    echo '<script language="javascript">window.history.back();</script>';
                                                        ...
                                                        echo '<script language="javascript">window.history.back();</script>';
                                                            ...
                                                            if($query == true){
                                                            $sintak = mysqli_query($config, "SELECT no_dentitif FROM tbl_berkas_khusus WHERE no_dentitif='$no_dentitif'");
        ...
        $query = mysqli_query($config, "SELECT  pencipta_arsip, deskripsi, kurun_waktu,keterangan, lokasi_simpan, jangka_simpan,id_user FROM tbl_berkas_khusus WHERE no_dentitif='$no_dentitif'");
        ...
        if($_SESSION['id_user'] != $id_user AND $_SESSION['admin'] ==2 ){
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper green darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">edit</i> Edit Berkas Khusus No Dentitif : <?php echo "$no_dentitif"; ?></a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <!-- Form START -->
                <form class="col s12" method="POST" action="?page=bks&act=edit&no_dentitif=<?php echo $no_dentitif ?>" enctype="multipart/form-data">
                         ...
                         <i class="material-icons prefix md-prefix">format_align_justify</i><label>Pilih Klasifikasi Berkas</label><br>
                            <div class="input-field col s11 right">
                                ...
                                <?php 
                                        ...
                                        $sintak = mysqli_query($config, "SELECT * FROM tbl_berkas_khusus where no_dentitif='$no_dentitif'");
