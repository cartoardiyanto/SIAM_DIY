<?php
    ...
    if(empty($_SESSION['admin'])){
    	...
    	$query = mysqli_query($config, "SELECT * FROM tbl_isi_berkas_koresponden WHERE no_itemi='$no_itemi'");
            ...
            while($row = mysqli_fetch_array($query)){
    		  ...
    		  echo '<!-- Row form Start -->
    				    ...
    				    <div class="col m12">
                            <div class="card">
                                ...
                                <div class="card-action">
        		                     ...
        		                     <a href="?page=bkr&act=isikoresponden&no_dentitif='.$no_dentitif.'&sub=del&submit=yes&no_item='.$row['no_itemi'].'" class="btn-large deep-orange waves-effect waves-light white-text">HAPUS <i class="material-icons">delete</i></a>
                                     
        		                    <a href="?page=bkr&act=isikoresponden&no_dentitif='.$no_dentitif.'" class="btn-large blue waves-effect waves-light white-text">BATAL <i class="material-icons">clear</i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    if(!empty($row['file'])){
                        ...
                        $query = mysqli_query($config, "DELETE FROM tbl_isi_berkas_koresponden WHERE no_itemi ='$no_item'");
                         ...
                         if($query == true){
                            ...
                            echo '<script language="javascript">
                                    window.location.href="./admin.php?page=bkr&act=isikoresponden&no_dentitif='.$no_dentitif.'&sub=del&no_item='.$no_item.'";
                                  </script>';
                        }
                    } else {
