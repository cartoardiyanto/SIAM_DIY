<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['sub'])){
            ...
            switch ($sub) {
                case 'add':
                    include "tambah_isi_bks.php";
                    break;
                case 'edit':
                    include "edit_isi_bks.php";
                    break;
                case 'del':
                    include "hapus_isi_bks.php";
                    break;
            }
        } else {
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper green darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                        <li class="waves-effect waves-light hide-on-small-only"><a href="#" class="judul"><i class="material-icons">description</i> Isi Berkas Khusus</a></li>
                                        <li class="waves-effect waves-light"><a href="?page=bks&act=isikhusus&no_dentitif='.$no_dentitif.'&sub=add"><i class="material-icons md-24">add_circle</i> Tambah Isi Berkas</a></li>
                                        <li class="waves-effect waves-light hide-on-small-only"><a href="?page=bks"><i class="material-icons">arrow_back</i> Kembali</a></li>
                                    </ul>
                                    </div>
                                    
                                    <div class="col m5 hide-on-med-and-down">
                                        <form method="post" action="?page=bks&act=isikhusus&no_dentitif='.$no_dentitif.'">
                ...
                <?php
                    ...
                    $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                        ...
                        <div class="col s12" style="margin-top: -18px;">
                            <div class="card blue lighten-5">
                                <div class="card-content">
                                <p class="description">Hasil pencarian untuk kata kunci <strong>"'.stripslashes($cari).'"</strong><span class="right"><a href="?page=bks&act=isikhusus&no_dentitif='.$no_dentitif.'"><i class="material-icons md-36" style="color: #333;">clear</i></a></span></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="bordered" id="tbl">
                           ...
                           $query = mysqli_query($config, "SELECT * FROM tbl_isi_berkas_khusus WHERE no_dentitifi ='$no_dentitif' and (pencipta_arsipi LIKE '%$cari%' or deskripsii LIKE '%$cari%') ORDER by no_itemi DESC LIMIT 15");
                                        ...
                                        if(!empty($row['file'])){
                                            echo ' <strong><a href="?page=fbks&act=fsm&no_item='.$row['no_itemi'].'&no_dentitif='.$no_dentitif.'">'.$row['file'].'</a></strong>';
                                        } else {
                                            echo '<em>Tidak ada file yang di upload</em>';
                                              ...
                                              if($_SESSION['admin'] ==2 ){
                                                     ...
                                                     echo'
                                                    <td><a class="btn small blue waves-effect waves-light" href="?page=bks&act=isikhusus&no_dentitif='.$no_dentitif.'&sub=edit&no_item='.$row['no_itemi'].'">
                                                            <i class="material-icons">edit</i> EDIT</a>
                                                        <a class="btn small deep-orange waves-effect waves-light" href="?page=bks&act=isikhusus&no_dentitif='.$no_dentitif.'&sub=del&no_item='.$row['no_itemi'].'"><i class="material-icons">delete</i> HAPUS</a>
                                                    </td>
                                                     </tr>';
                                            }
                    ...
                    <!-- Row form END -->';
                        ...
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
                                                            ...
                                                            <div class="input-field col s12">
                                                                ...
                                                                <div class="modal-footer white">
                                                                    ...
                                                                    if(isset($_REQUEST['simpan'])){
                                                                        ...
                                                                        if($query == true){
                                                                            header("Location: ./admin.php?page=bks&act=isikhusus&no_dentitif=$no_dentitif");
                                                                            die();
                                                                        }
                                                                    } echo '
                                ...
                                $query2 = mysqli_query($config, "SELECT * FROM tbl_isi_berkas_khusus WHERE no_dentitifi =  '$no_dentitif' ORDER by no_itemi DESC LIMIT $curr, $limit");
                    ...
                    $query = mysqli_query($config, "SELECT * FROM tbl_isi_berkas_khusus WHERE no_dentitifi='$no_dentitif'");
                    ...
                    if($cdata > $limit ){
                        ...
                        if($pg > 1){
                            $prev = $pg - 1;
                            echo '<li><a href="?page=bks&act=isikhusus&no_dentitif='.$no_dentitif.'&pg=1"><i class="material-icons md-48">first_page</i></a></li>
                                  <li><a href="?page=bks&act=isikhusus&no_dentitif='.$no_dentitif.'&pg='.$prev.'"><i class="material-icons md-48">chevron_left</i></a></li>';
                        } else {
                        ...
                        for ($i = 1; $i <= $cpg; $i++) {
                            if ((($i >= $pg - 3) && ($i <= $pg + 3)) || ($i == 1) || ($i == $cpg)) {
                                if ($i == $pg) echo '<li class="active waves-effect waves-dark"><a href="?page=bks&act=isikhusus&no_dentitif='.$no_dentitif.'&pg='.$i.'"> '.$i.' </a></li>';
                                else echo '<li class="waves-effect waves-dark"><a href="?page=bks&act=isikhusus&no_dentitif='.$no_dentitif.'&pg='.$i.'"> '.$i.' </a></li>';
                            }
                        }
                        ...
                        if($pg < $cpg){
                            $next = $pg + 1;
                            echo '<li><a href="?page=bks&act=isikhusus&no_dentitif='.$no_dentitif.'&pg='.$next.'"><i class="material-icons md-48">chevron_right</i></a></li>
                                  <li><a href="?page=bks&act=isikhusus&no_dentitif='.$no_dentitif.'&pg='.$cpg.'"><i class="material-icons md-48">last_page</i></a></li>';
                        } else {
