<?php
    ...
    if(empty($_SESSION['admin'])){
                                         ...
                                         echo '<script language="javascript">window.history.back();</script>';
                                            ...
                                            if(!preg_match("/^[a-zA-Z0-9., ]*$/", $keterangani)){
                                                ...
                                                if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $lokasi_simpani)){
                                                    ...
                                                    $target_dir = "upload/berkas_khusus/";
                                            ...
                                            if($file != ""){
                                                ...
                                                if(in_array($eks, $ekstensi) == true){
                                                    if($ukuran < 2500000){
                                                        ...
                                                        $query = mysqli_query($config, "SELECT file FROM tbl_isi_berkas_khusus WHERE no_itemi='$no_item'");
        ...
        $no_item=$_REQUEST['no_item'];
        $query = mysqli_query($config, "SELECT id_kodei,pencipta_arsipi,deskripsii,kurun_waktui,tingkat_perkembangani,jumlahi,keterangani,lokasi_simpani,file,jangka_simpani,no_dentitifi FROM tbl_isi_berkas_khusus WHERE no_itemi='$no_item'");
                    ...
                    <div class="col s12">
                        <nav class="secondary-nav">
                            <div class="nav-wrapper green darken-1">
                                <ul class="left">
                                    <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">edit</i> Edit isi Berkas Khusus No Item : <?php echo "$no_item";?></a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                    ...
                    <form class="col s12" method="post" action="" enctype="multipart/form-data">
                         ...
                         <i class="material-icons prefix md-prefix">format_align_justify</i><label>Pilih Klasifikasi Berkas</label><br>
                            <div class="input-field col s11 right">
                                ...
                                <?php 
                                 ...
                                 $query = mysqli_query($config, "SELECT* FROM tbl_opsi_klasifikasi id_kode < 41");
                       ...
                       <div class="input-field col s6 right">
                        ...
                        <div class="row">
                            ...
                            <div class="col 6">
                                <a href="?page=bks&act=isikhusus&no_dentitif=<?php echo $no_dentitif ?>" class="btn-large deep-orange waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
                            </div>
                        </div>
