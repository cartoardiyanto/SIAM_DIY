     ...
     if($_SESSION['admin'] ==2 ){
        ...
        if(isset($_REQUEST['submit'])){
                                                ...
                                                if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $lokasi_simpan)){
                                                    ...
                                                    echo '<script language="javascript">window.history.back();</script>';
                                                        ...
                                                        echo '<script language="javascript">window.history.back();</script>';
                                                            ...
                                                            $sintak2 = mysqli_query($config, "SELECT * FROM tbl_berkas_koresponden ");
                                                            ...
                                                            $query = mysqli_query($config, "INSERT INTO tbl_berkas_koresponden(no_dentitif, id_kode, kode_klasifikasi, pencipta_arsip, deskripsi, kurun_waktu,keterangan, lokasi_simpan, jangka_simpan, id_user)
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper green darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=bkr&act=add" class="judul"><i class="material-icons">storage</i> Tambah Data Berkas koresponden</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <!-- Form START -->
                <form class="col s12" method="POST" action="?page=bkr&act=add" enctype="multipart/form-data">
