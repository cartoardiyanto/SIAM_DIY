...
<head>
    ...
    <?php
        echo '<link rel="shortcut icon" href="./asset/img/logo.jpg">';
    ?>
    <!-- Meta END -->
                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    <div class="col s12">
                        <div class="card-content">
                            <h5 class="center" class="ams hide-on-med-and-down" id="title">Sistem Informasi Arsip </h5>
                            <img id="logo" src="asset/img/logo.jpg">
                            <br>
                            <h5 class="center" id="title">Muhamdiyah DIY</h5>
                    ...
                    <?php
                        if(isset($_REQUEST['submit'])){
                            ...
                            if($_REQUEST['username'] == "" || $_REQUEST['password'] == ""){
                                ...
                                <a class="btn-large waves-effect waves-light green col s11" href="" style="margin: 20px 0 0 5px;"><i class="material-icons md-24">arrow_back</i> Kembali ke login form</a></div>';
                            } else {
                                ...
                                $query = mysqli_query($config, "SELECT id_user, username, nama, nik, admin FROM tbl_user WHERE username=BINARY'$username' AND password=MD5('$password')");
                    ...
                    <form class="col s12 m12 offset-4 offset-4" method="POST" action="" >
                        ...
                        <div class="input-field col s12">
                            <button type="submit" class="btn-large waves-effect waves-dark green col s12" name="submit">LOGIN</button>
                        </div>
                    </form>
                    <!-- Form END -->
                    <?php
