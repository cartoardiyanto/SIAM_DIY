                                         ...
                                         echo '<script language="javascript">window.history.back();</script>';
                                                    ...
                                                    if($file != ""){
                                                        ...
                                                        if(in_array($eks, $ekstensi) == true){
                                                            ...
                                                            $s = mysqli_query($config, "SELECT * FROM tbl_isi_berkas_khusus 
                                                            ...
                                                            $lokasi_simpani=(implode(".",$satuin));
                                                                $query = mysqli_query($config, "INSERT INTO tbl_isi_berkas_khusus(no_itemi ,id_kodei,kode_klasifikasi,pencipta_arsipi,deskripsii,kurun_waktui,tingkat_perkembangani,jumlahi,keterangani,lokasi_simpani,file,jangka_simpani,no_dentitifi,id_useri)
                                                            ...
                                                            $sintak3 = mysqli_query($config, "SELECT * FROM tbl_isi_berkas_khusus where no_dentitifi='$no_dentitif' ");
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper green darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">note_add   </i> Tambah Isi Berkas Khusus
           </a></li>
                            </ul>
                        </div>
                    </nav>
