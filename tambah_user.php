<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['username'] == "" || $_REQUEST['password'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['nik'] == "" || $_REQUEST['admin'] == ""){
                ...
                if(!preg_match("/^[a-zA-Z0-9_]*$/", $username)){
                    ...
                    if(!preg_match("/^[a-zA-Z., ]*$/", $nama)){
                        ...
                        if(!preg_match("/^[0-9. -]*$/", $nik)){
                            $_SESSION['nipuser'] = 'Form NIK hanya boleh mengandung karakter angka, spasi dan minus(-)';
                            echo '<script language="javascript">window.history.back();</script>';
                        } else {
                                ...
                                if($result > 0){
                                    ...
                                    if(strlen($username) < 5){
                                        ...
                                        if(strlen($password) < 5){
                                            ...
                                            $query = mysqli_query($config, "INSERT INTO tbl_user(username,password,nama,nik,admin) VALUES('$username',MD5('$password'),'$nama','$nik','$admin')");
