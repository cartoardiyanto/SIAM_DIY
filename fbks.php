<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        $query = mysqli_query($config, "SELECT * FROM tbl_isi_berkas_khusus WHERE no_itemi='$no_itemi' AND no_dentitifi = '$no_dentitifi'");
                    ...
                    <div class="row jarak-form">
                        ...
                        if(empty($row['file'])){
                            ...
                            if(in_array($eks, $ekstensi) == true){
                                echo '<img class="gbr" data-caption="'.date('d M Y', strtotime($row['tgl_diterima'])).'" src="./upload/berkas_khusus/'.$row['file'].'"/>';
                            } else {
                                                ...
                                                <div class="col s9 left">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-action">
                                                            <strong>Lihat file :</strong> <a class="blue-text" href="./upload/berkas_khusus/'.$row['file'].'" target="_blank">'.$row['file'].'</a>
                                                        </div>
                                                    </div>
                                                </div>
